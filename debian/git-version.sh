#!/bin/sh
# Script to output a version string with the number of commits since the base
# commit (i.e. the commit which started the CURRENT_BASE release)
...
NB_OF_COMMITS=`git --git-dir $1 log --oneline $CURRENT_BASE_COMMIT..HEAD | wc -l`
